/**
 * ObterSituacaoComprovantes.java
 * <p>
...
/**
 * ObterSituacaoComprovantes bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class ObterSituacaoComprovantes
        implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://www.geravd.com.br/Servicos/PessoaWebService",
            "ObterSituacaoComprovantes",
            "ns1");
    ...
    protected int localTipoComprovante;
     ...
     */
    public void setTipoComprovante(int param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":ObterSituacaoComprovantes",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "ObterSituacaoComprovantes",
        ...
        if (localTipoComprovante == java.lang.Integer.MIN_VALUE) {
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        elementList.add(
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localTipoComprovante));
    ...
    public static class Factory {
         ...
         */
        public static ObterSituacaoComprovantes parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ObterSituacaoComprovantes object =
                    new ObterSituacaoComprovantes();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ObterSituacaoComprovantes".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ObterSituacaoComprovantes) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
