/**
 * ObterCodigoEstruturaGeografica.java
 * <p>
...
/**
 *  ObterCodigoEstruturaGeografica bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class ObterCodigoEstruturaGeografica
        implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://www.geravd.com.br/Servicos/PessoaWebService",
            "ObterCodigoEstruturaGeografica",
            "ns1");
    ...
    protected int localNivelEstrutura;
     ...
     */
    public void setNivelEstrutura(int param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":ObterCodigoEstruturaGeografica",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "ObterCodigoEstruturaGeografica",
        ...
        if (localNivelEstrutura == java.lang.Integer.MIN_VALUE) {
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        elementList.add(
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localNivelEstrutura));
        if (localLoginTracker) {
            elementList.add(new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService",
                    "login"));
    ...
    public static class Factory {
         ...
         */
        public static ObterCodigoEstruturaGeografica parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ObterCodigoEstruturaGeografica object =
                    new ObterCodigoEstruturaGeografica();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ObterCodigoEstruturaGeografica".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ObterCodigoEstruturaGeografica) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
