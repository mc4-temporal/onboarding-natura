/**
 * RetornoSituacaoComprovanteContrato.java
 * <p>
...
/**
 *  RetornoSituacaoComprovanteContrato bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class RetornoSituacaoComprovanteContrato extends bo.com.mc4.onboarding.integrations.gera.wsdl.gen.RetornoWebService
        implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
                name = RetornoSituacaoComprovanteContrato
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                    namespacePrefix + ":RetornoSituacaoComprovanteContrato",
                    xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "RetornoSituacaoComprovanteContrato",
                    xmlWriter);
        }
        ...
        if (localSituacao == java.lang.Integer.MIN_VALUE) {
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        attribList.add(new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "RetornoSituacaoComprovanteContrato"));
        if (localMensagemErroTracker) {
        ...
        elementList.add(
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localSituacao));
    ...
    public static class Factory {
         ...
         */
        public static RetornoSituacaoComprovanteContrato parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RetornoSituacaoComprovanteContrato object =
                    new RetornoSituacaoComprovanteContrato();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"RetornoSituacaoComprovanteContrato".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (RetornoSituacaoComprovanteContrato) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
