/**
 * RetornoObterSetoresIndicacao.java
 * <p>
...
/**
 *  RetornoObterSetoresIndicacao bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class RetornoObterSetoresIndicacao extends bo.com.mc4.onboarding.integrations.gera.wsdl.gen.RetornoWebService
        implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
                name = RetornoObterSetoresIndicacao
    ...
    protected java.lang.String localEstrutura;
     ...
     */
    public void setEstrutura(java.lang.String param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                    namespacePrefix + ":RetornoObterSetoresIndicacao",
                    xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
        ...
        if (localEstruturaTracker) {
            namespace = "http://www.geravd.com.br/Servicos/PessoaWebService";
            writeStartElement(null, namespace, "Estrutura", xmlWriter);
            ...
            if (localEstrutura == null) {
                ...
                xmlWriter.writeCharacters(localEstrutura);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        attribList.add(new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "RetornoObterSetoresIndicacao"));
        if (localMensagemErroTracker) {
        ...
        if (localEstruturaTracker) {
            ...
            if (localEstrutura != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localEstrutura));
            } else {
                throw new org.apache.axis2.databinding.ADBException("Estrutura cannot be null!!");
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static RetornoObterSetoresIndicacao parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RetornoObterSetoresIndicacao object =
                    new RetornoObterSetoresIndicacao();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"RetornoObterSetoresIndicacao".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (RetornoObterSetoresIndicacao) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
