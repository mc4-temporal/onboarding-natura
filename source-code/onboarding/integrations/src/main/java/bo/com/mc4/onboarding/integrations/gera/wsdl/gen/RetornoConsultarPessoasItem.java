/**
 * RetornoConsultarPessoasItem.java
 * <p>
...
/**
 * RetornoConsultarPessoasItem bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class RetornoConsultarPessoasItem
        implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
                name = RetornoConsultarPessoasItem
    ...
    /**
     * field for DocumentoIdentidade
     */


    protected java.lang.String localDocumentoIdentidade;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localDocumentoIdentidadeTracker = false;

    public boolean isDocumentoIdentidadeSpecified() {
        return localDocumentoIdentidadeTracker;
    }
     ...
     */
    public java.lang.String getDocumentoIdentidade() {
     ...
     * Auto generated setter method
     *
     * @param param DocumentoIdentidade
     */
    public void setDocumentoIdentidade(java.lang.String param) {
        localDocumentoIdentidadeTracker = param != null;

        this.localDocumentoIdentidade = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":RetornoConsultarPessoasItem",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
        ...
        if (localDocumentoIdentidadeTracker) {
            namespace = "http://www.geravd.com.br/Servicos/PessoaWebService";
            writeStartElement(null, namespace, "DocumentoIdentidade", xmlWriter);


            if (localDocumentoIdentidade == null) {
                // write the nil attribute

                throw new org.apache.axis2.databinding.ADBException("DocumentoIdentidade cannot be null!!");

            } else {


                xmlWriter.writeCharacters(localDocumentoIdentidade);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (localDocumentoIdentidadeTracker) {
            ...
            if (localDocumentoIdentidade != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localDocumentoIdentidade));
            } else {
                throw new org.apache.axis2.databinding.ADBException("DocumentoIdentidade cannot be null!!");
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static RetornoConsultarPessoasItem parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RetornoConsultarPessoasItem object =
                    new RetornoConsultarPessoasItem();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"RetornoConsultarPessoasItem".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (RetornoConsultarPessoasItem) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "DocumentoIdentidade").equals(reader.getName())) {

                    java.lang.String content = reader.getElementText();

                    object.setDocumentoIdentidade(
