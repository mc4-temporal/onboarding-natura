...
/**
 *  Consultar_deudas_MC bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class Consultar_deudas_MC
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":consultar_deudas_MC",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "consultar_deudas_MC",
    ...
    public static class Factory {
         ...
         */
        public static Consultar_deudas_MC parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            Consultar_deudas_MC object =
                    new Consultar_deudas_MC();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"consultar_deudas_MC".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (Consultar_deudas_MC) bo.com.mc4.onboarding.integrations.infocenter.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
