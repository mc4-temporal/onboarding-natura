...
/**
 * RecuperarNovaSenha bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class RecuperarNovaSenha
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":RecuperarNovaSenha",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "RecuperarNovaSenha",
    ...
    public static class Factory {
         ...
         */
        public static RecuperarNovaSenha parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RecuperarNovaSenha object =
                    new RecuperarNovaSenha();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"RecuperarNovaSenha".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (RecuperarNovaSenha) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
