/**
 * ObterEstruturaComercialPessoa.java
 * <p>
...
/**
 *  ObterEstruturaComercialPessoa bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class ObterEstruturaComercialPessoa
        implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://www.geravd.com.br/Servicos/PessoaWebService",
            "ObterEstruturaComercialPessoa",
            "ns1");
    ...
    /**
     * field for QtdeNiveisDescendentes
     */


    protected int localQtdeNiveisDescendentes;
     ...
     * @return int
     */
    public int getQtdeNiveisDescendentes() {
        return localQtdeNiveisDescendentes;
    }


    /**
     * Auto generated setter method
     * @param param QtdeNiveisDescendentes
     */
    public void setQtdeNiveisDescendentes(int param) {

        this.localQtdeNiveisDescendentes = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":ObterEstruturaComercialPessoa",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "ObterEstruturaComercialPessoa",
        ...
        namespace = "http://www.geravd.com.br/Servicos/PessoaWebService";
        writeStartElement(null, namespace, "qtdeNiveisDescendentes", xmlWriter);

        if (localQtdeNiveisDescendentes == java.lang.Integer.MIN_VALUE) {

            throw new org.apache.axis2.databinding.ADBException("qtdeNiveisDescendentes cannot be null!!");

        } else {
            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localQtdeNiveisDescendentes));
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        elementList.add(new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService",
                "qtdeNiveisDescendentes"));

        elementList.add(
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localQtdeNiveisDescendentes));
    ...
    public static class Factory {
         ...
         */
        public static ObterEstruturaComercialPessoa parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ObterEstruturaComercialPessoa object =
                    new ObterEstruturaComercialPessoa();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ObterEstruturaComercialPessoa".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ObterEstruturaComercialPessoa) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "qtdeNiveisDescendentes").equals(reader.getName())) {

                    java.lang.String content = reader.getElementText();

                    object.setQtdeNiveisDescendentes(
                            org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(content));
