...
/**
 *  Consultar_persona_deudas bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class Consultar_persona_deudas
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":consultar_persona_deudas",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "consultar_persona_deudas",
    ...
    public static class Factory {
         ...
         */
        public static Consultar_persona_deudas parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            Consultar_persona_deudas object =
                    new Consultar_persona_deudas();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"consultar_persona_deudas".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (Consultar_persona_deudas) bo.com.mc4.onboarding.integrations.infocenter.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
