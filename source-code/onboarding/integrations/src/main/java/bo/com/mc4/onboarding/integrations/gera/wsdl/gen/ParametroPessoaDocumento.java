...
/**
 * ParametroPessoaDocumento bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class ParametroPessoaDocumento
        implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
                name = ParametroPessoaDocumento
    ...
    protected java.lang.String localInfoExtra;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localInfoExtraTracker = false;

    public boolean isInfoExtraSpecified() {
        return localInfoExtraTracker;
    }
     ...
     * @return java.lang.String
     */
    public java.lang.String getInfoExtra() {
        return localInfoExtra;
    }
     ...
     * Auto generated setter method
     *
     * @param param InfoExtra
     */
    public void setInfoExtra(java.lang.String param) {
        localInfoExtraTracker = param != null;

        this.localInfoExtra = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":ParametroPessoaDocumento",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
        ...
        if (localInfoExtraTracker) {
            namespace = "http://www.geravd.com.br/Servicos/PessoaWebService";
            writeStartElement(null, namespace, "InfoExtra", xmlWriter);


            if (localInfoExtra == null) {
                // write the nil attribute

                throw new org.apache.axis2.databinding.ADBException("InfoExtra cannot be null!!");

            } else {


                xmlWriter.writeCharacters(localInfoExtra);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (localInfoExtraTracker) {
            ...
            if (localInfoExtra != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localInfoExtra));
            } else {
                throw new org.apache.axis2.databinding.ADBException("InfoExtra cannot be null!!");
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ParametroPessoaDocumento parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ParametroPessoaDocumento object =
                    new ParametroPessoaDocumento();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ParametroPessoaDocumento".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ParametroPessoaDocumento) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "InfoExtra").equals(reader.getName())) {
