/**
 * ParametroPessoaReferenciaPessoal.java
 * <p>
...
/**
 *  ParametroPessoaReferenciaPessoal bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class ParametroPessoaReferenciaPessoal
        implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
                name = ParametroPessoaReferenciaPessoal
    ...
    protected java.lang.String localRelacao;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localRelacaoTracker = false;

    public boolean isRelacaoSpecified() {
        return localRelacaoTracker;
    }
     ...
     * @return java.lang.String
     */
    public java.lang.String getRelacao() {
        return localRelacao;
    }
     ...
     * @param param Relacao
     */
    public void setRelacao(java.lang.String param) {
        localRelacaoTracker = param != null;

        this.localRelacao = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":ParametroPessoaReferenciaPessoal",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
        ...
        if (localRelacaoTracker) {
            namespace = "http://www.geravd.com.br/Servicos/PessoaWebService";
            writeStartElement(null, namespace, "Relacao", xmlWriter);


            if (localRelacao == null) {
                // write the nil attribute

                throw new org.apache.axis2.databinding.ADBException("Relacao cannot be null!!");

            } else {


                xmlWriter.writeCharacters(localRelacao);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (localRelacaoTracker) {
            ...
            if (localRelacao != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localRelacao));
            } else {
                throw new org.apache.axis2.databinding.ADBException("Relacao cannot be null!!");
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ParametroPessoaReferenciaPessoal parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ParametroPessoaReferenciaPessoal object =
                    new ParametroPessoaReferenciaPessoal();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ParametroPessoaReferenciaPessoal".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ParametroPessoaReferenciaPessoal) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "Relacao").equals(reader.getName())) {
