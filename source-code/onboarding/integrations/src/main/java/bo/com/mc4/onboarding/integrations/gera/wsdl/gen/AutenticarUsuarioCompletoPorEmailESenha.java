/**
 * AutenticarUsuarioCompletoPorEmailESenha.java
 * <p>
...
/**
 *  AutenticarUsuarioCompletoPorEmailESenha bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class AutenticarUsuarioCompletoPorEmailESenha
        implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://www.geravd.com.br/Servicos/PessoaWebService",
            "AutenticarUsuarioCompletoPorEmailESenha",
            "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":AutenticarUsuarioCompletoPorEmailESenha",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "AutenticarUsuarioCompletoPorEmailESenha",
    ...
    public static class Factory {
         ...
         */
        public static AutenticarUsuarioCompletoPorEmailESenha parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            AutenticarUsuarioCompletoPorEmailESenha object =
                    new AutenticarUsuarioCompletoPorEmailESenha();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"AutenticarUsuarioCompletoPorEmailESenha".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (AutenticarUsuarioCompletoPorEmailESenha) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
