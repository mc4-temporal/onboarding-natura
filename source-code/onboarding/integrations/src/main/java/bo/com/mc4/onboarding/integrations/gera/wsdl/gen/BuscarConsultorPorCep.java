...
/**
 * BuscarConsultorPorCep bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class BuscarConsultorPorCep
        implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://www.geravd.com.br/Servicos/PessoaWebService",
            "BuscarConsultorPorCep",
            "ns1");
    ...
    protected int localCodigoPostal;
     ...
     */
    public void setCodigoPostal(int param) {
    ...
    /**
     * field for RetornoMinimo
     */


    protected int localRetornoMinimo;
     ...
     * @return int
     */
    public int getRetornoMinimo() {
        return localRetornoMinimo;
    }
     ...
     * Auto generated setter method
     *
     * @param param RetornoMinimo
     */
    public void setRetornoMinimo(int param) {

        this.localRetornoMinimo = param;
    ...
    /**
     * field for RetornoMaximo
     */


    protected int localRetornoMaximo;
     ...
     * Auto generated setter method
     *
     * @param param RetornoMaximo
     */
    public void setRetornoMaximo(int param) {

        this.localRetornoMaximo = param;
    ...
    /**
     * field for LimiteGeografico
     */


    protected int localLimiteGeografico;
     ...
     * @return int
     */
    public int getLimiteGeografico() {
        return localLimiteGeografico;
    }
     ...
     * Auto generated setter method
     *
     * @param param LimiteGeografico
     */
    public void setLimiteGeografico(int param) {

        this.localLimiteGeografico = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":BuscarConsultorPorCep",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "BuscarConsultorPorCep",
        ...
        if (localCodigoPostal == java.lang.Integer.MIN_VALUE) {

            throw new org.apache.axis2.databinding.ADBException("codigoPostal cannot be null!!");

        } else {
            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCodigoPostal));
        }

        xmlWriter.writeEndElement();

        namespace = "http://www.geravd.com.br/Servicos/PessoaWebService";
        writeStartElement(null, namespace, "retornoMinimo", xmlWriter);

        if (localRetornoMinimo == java.lang.Integer.MIN_VALUE) {

            throw new org.apache.axis2.databinding.ADBException("retornoMinimo cannot be null!!");

        } else {
            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localRetornoMinimo));
        }

        xmlWriter.writeEndElement();

        namespace = "http://www.geravd.com.br/Servicos/PessoaWebService";
        writeStartElement(null, namespace, "retornoMaximo", xmlWriter);

        if (localRetornoMaximo == java.lang.Integer.MIN_VALUE) {

            throw new org.apache.axis2.databinding.ADBException("retornoMaximo cannot be null!!");

        } else {
            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localRetornoMaximo));
        }

        xmlWriter.writeEndElement();

        namespace = "http://www.geravd.com.br/Servicos/PessoaWebService";
        writeStartElement(null, namespace, "limiteGeografico", xmlWriter);

        if (localLimiteGeografico == java.lang.Integer.MIN_VALUE) {

            throw new org.apache.axis2.databinding.ADBException("limiteGeografico cannot be null!!");

        } else {
            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localLimiteGeografico));
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        elementList.add(
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localRetornoMinimo));

        elementList.add(new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService",
                "retornoMaximo"));

        elementList.add(
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localRetornoMaximo));

        elementList.add(new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService",
                "limiteGeografico"));

        elementList.add(
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localLimiteGeografico));
        if (localLoginTracker) {
            elementList.add(new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService",
                    "login"));
    ...
    public static class Factory {
         ...
         */
        public static BuscarConsultorPorCep parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            BuscarConsultorPorCep object =
                    new BuscarConsultorPorCep();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"BuscarConsultorPorCep".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (BuscarConsultorPorCep) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "retornoMinimo").equals(reader.getName())) {

                    java.lang.String content = reader.getElementText();

                    object.setRetornoMinimo(
                            org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(content));
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "retornoMaximo").equals(reader.getName())) {

                    java.lang.String content = reader.getElementText();

                    object.setRetornoMaximo(
                            org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(content));
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "limiteGeografico").equals(reader.getName())) {

                    java.lang.String content = reader.getElementText();

                    object.setLimiteGeografico(
                            org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(content));
