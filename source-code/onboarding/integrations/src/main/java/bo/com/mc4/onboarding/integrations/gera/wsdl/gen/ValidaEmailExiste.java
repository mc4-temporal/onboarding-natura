...
/**
 * ValidaEmailExiste bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class ValidaEmailExiste
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":ValidaEmailExiste",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "ValidaEmailExiste",
    ...
    public static class Factory {
         ...
         */
        public static ValidaEmailExiste parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ValidaEmailExiste object =
                    new ValidaEmailExiste();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ValidaEmailExiste".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ValidaEmailExiste) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
