/**
 * RetornoRecuperarSenhaPerguntaSecreta.java
 * <p>
...
/**
 *  RetornoRecuperarSenhaPerguntaSecreta bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class RetornoRecuperarSenhaPerguntaSecreta extends bo.com.mc4.onboarding.integrations.gera.wsdl.gen.RetornoWebService
        implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
                name = RetornoRecuperarSenhaPerguntaSecreta
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                    namespacePrefix + ":RetornoRecuperarSenhaPerguntaSecreta",
                    xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "RetornoRecuperarSenhaPerguntaSecreta",
                    xmlWriter);
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        attribList.add(new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "RetornoRecuperarSenhaPerguntaSecreta"));
        if (localMensagemErroTracker) {
    ...
    public static class Factory {
         ...
         */
        public static RetornoRecuperarSenhaPerguntaSecreta parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RetornoRecuperarSenhaPerguntaSecreta object =
                    new RetornoRecuperarSenhaPerguntaSecreta();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"RetornoRecuperarSenhaPerguntaSecreta".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (RetornoRecuperarSenhaPerguntaSecreta) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
