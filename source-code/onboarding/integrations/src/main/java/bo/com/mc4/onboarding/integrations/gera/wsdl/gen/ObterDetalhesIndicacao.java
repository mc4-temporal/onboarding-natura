...
/**
 * ObterDetalhesIndicacao bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class ObterDetalhesIndicacao
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":ObterDetalhesIndicacao",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "ObterDetalhesIndicacao",
    ...
    public static class Factory {
         ...
         */
        public static ObterDetalhesIndicacao parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ObterDetalhesIndicacao object =
                    new ObterDetalhesIndicacao();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ObterDetalhesIndicacao".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ObterDetalhesIndicacao) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
