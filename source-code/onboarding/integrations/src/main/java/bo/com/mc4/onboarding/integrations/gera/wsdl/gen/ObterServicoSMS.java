...
/**
 * ObterServicoSMS bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class ObterServicoSMS
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":ObterServicoSMS",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "ObterServicoSMS",
    ...
    public static class Factory {
         ...
         */
        public static ObterServicoSMS parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ObterServicoSMS object =
                    new ObterServicoSMS();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ObterServicoSMS".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ObterServicoSMS) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
