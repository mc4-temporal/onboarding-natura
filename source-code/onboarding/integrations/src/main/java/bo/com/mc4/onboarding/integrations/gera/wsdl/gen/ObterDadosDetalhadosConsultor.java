/**
 * ObterDadosDetalhadosConsultor.java
 * <p>
...
/**
 *  ObterDadosDetalhadosConsultor bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class ObterDadosDetalhadosConsultor
        implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://www.geravd.com.br/Servicos/PessoaWebService",
            "ObterDadosDetalhadosConsultor",
            "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":ObterDadosDetalhadosConsultor",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "ObterDadosDetalhadosConsultor",
    ...
    public static class Factory {
         ...
         */
        public static ObterDadosDetalhadosConsultor parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ObterDadosDetalhadosConsultor object =
                    new ObterDadosDetalhadosConsultor();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ObterDadosDetalhadosConsultor".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ObterDadosDetalhadosConsultor) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
