...
/**
 * ObterCamposExpirados bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class ObterCamposExpirados
        implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://www.geravd.com.br/Servicos/PessoaWebService",
            "ObterCamposExpirados",
            "ns1");
    ...
    /**
     * field for DiasConsultaExpirados
     */


    protected int localDiasConsultaExpirados;
     ...
     * @return int
     */
    public int getDiasConsultaExpirados() {
        return localDiasConsultaExpirados;
    }
     ...
     * Auto generated setter method
     *
     * @param param DiasConsultaExpirados
     */
    public void setDiasConsultaExpirados(int param) {

        this.localDiasConsultaExpirados = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":ObterCamposExpirados",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "ObterCamposExpirados",
        ...
        namespace = "http://www.geravd.com.br/Servicos/PessoaWebService";
        writeStartElement(null, namespace, "diasConsultaExpirados", xmlWriter);

        if (localDiasConsultaExpirados == java.lang.Integer.MIN_VALUE) {

            throw new org.apache.axis2.databinding.ADBException("diasConsultaExpirados cannot be null!!");

        } else {
            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localDiasConsultaExpirados));
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        elementList.add(new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService",
                "diasConsultaExpirados"));

        elementList.add(
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localDiasConsultaExpirados));
        if (localLoginTracker) {
            elementList.add(new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService",
                    "login"));
    ...
    public static class Factory {
         ...
         */
        public static ObterCamposExpirados parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ObterCamposExpirados object =
                    new ObterCamposExpirados();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ObterCamposExpirados".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ObterCamposExpirados) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "diasConsultaExpirados").equals(reader.getName())) {

                    java.lang.String content = reader.getElementText();

                    object.setDiasConsultaExpirados(
                            org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(content));
