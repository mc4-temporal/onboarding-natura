/**
 * ObterCiclosEstruturaComercial.java
 * <p>
...
/**
 *  ObterCiclosEstruturaComercial bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class ObterCiclosEstruturaComercial
        implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://www.geravd.com.br/Servicos/PessoaWebService",
            "ObterCiclosEstruturaComercial",
            "ns1");
    ...
    /**
     * field for QtdeCiclos
     */


    protected int localQtdeCiclos;
     ...
     * @return int
     */
    public int getQtdeCiclos() {
        return localQtdeCiclos;
    }


    /**
     * Auto generated setter method
     * @param param QtdeCiclos
     */
    public void setQtdeCiclos(int param) {

        this.localQtdeCiclos = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":ObterCiclosEstruturaComercial",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "ObterCiclosEstruturaComercial",
        ...
        namespace = "http://www.geravd.com.br/Servicos/PessoaWebService";
        writeStartElement(null, namespace, "qtdeCiclos", xmlWriter);

        if (localQtdeCiclos == java.lang.Integer.MIN_VALUE) {

            throw new org.apache.axis2.databinding.ADBException("qtdeCiclos cannot be null!!");

        } else {
            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localQtdeCiclos));
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        elementList.add(
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localQtdeCiclos));
    ...
    public static class Factory {
         ...
         */
        public static ObterCiclosEstruturaComercial parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ObterCiclosEstruturaComercial object =
                    new ObterCiclosEstruturaComercial();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ObterCiclosEstruturaComercial".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ObterCiclosEstruturaComercial) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "qtdeCiclos").equals(reader.getName())) {

                    java.lang.String content = reader.getElementText();

                    object.setQtdeCiclos(
                            org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(content));
