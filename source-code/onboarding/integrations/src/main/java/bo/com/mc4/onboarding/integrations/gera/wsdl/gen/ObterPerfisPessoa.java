...
/**
 * ObterPerfisPessoa bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class ObterPerfisPessoa
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":ObterPerfisPessoa",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "ObterPerfisPessoa",
    ...
    public static class Factory {
         ...
         */
        public static ObterPerfisPessoa parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ObterPerfisPessoa object =
                    new ObterPerfisPessoa();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ObterPerfisPessoa".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ObterPerfisPessoa) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
