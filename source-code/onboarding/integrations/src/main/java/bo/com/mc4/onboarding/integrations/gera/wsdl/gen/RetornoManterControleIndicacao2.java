/**
 * RetornoManterControleIndicacao2.java
 * <p>
...
/**
 *  RetornoManterControleIndicacao2 bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class RetornoManterControleIndicacao2 extends bo.com.mc4.onboarding.integrations.gera.wsdl.gen.RetornoWebService
        implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
                name = RetornoManterControleIndicacao2
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                    namespacePrefix + ":RetornoManterControleIndicacao2",
                    xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        attribList.add(new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "RetornoManterControleIndicacao2"));
        if (localMensagemErroTracker) {
    ...
    public static class Factory {
         ...
         */
        public static RetornoManterControleIndicacao2 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RetornoManterControleIndicacao2 object =
                    new RetornoManterControleIndicacao2();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"RetornoManterControleIndicacao2".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (RetornoManterControleIndicacao2) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
