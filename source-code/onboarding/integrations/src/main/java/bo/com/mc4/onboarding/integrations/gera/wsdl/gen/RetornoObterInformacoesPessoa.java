/**
 * RetornoObterInformacoesPessoa.java
 * <p>
...
/**
 *  RetornoObterInformacoesPessoa bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class RetornoObterInformacoesPessoa extends bo.com.mc4.onboarding.integrations.gera.wsdl.gen.RetornoWebService
        implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
                name = RetornoObterInformacoesPessoa
    ...
    /**
     * field for NomesPapeis
     */


    protected bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ArrayOfString localNomesPapeis;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localNomesPapeisTracker = false;

    public boolean isNomesPapeisSpecified() {
        return localNomesPapeisTracker;
    }
     ...
     */
    public bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ArrayOfString getNomesPapeis() {
        return localNomesPapeis;
    }


    /**
     * Auto generated setter method
     * @param param NomesPapeis
     */
    public void setNomesPapeis(bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ArrayOfString param) {
        localNomesPapeisTracker = param != null;

        this.localNomesPapeis = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                    namespacePrefix + ":RetornoObterInformacoesPessoa",
                    xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "RetornoObterInformacoesPessoa",
                    xmlWriter);
        }
        ...
        if (localNomesPapeisTracker) {
            if (localNomesPapeis == null) {
                throw new org.apache.axis2.databinding.ADBException("NomesPapeis cannot be null!!");
            }
            localNomesPapeis.serialize(new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "NomesPapeis"),
                    xmlWriter);
        }
        xmlWriter.writeEndElement();
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        attribList.add(new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "RetornoObterInformacoesPessoa"));
        if (localMensagemErroTracker) {
        ...
        if (localNomesPapeisTracker) {
            ...
            elementList.add(localNomesPapeis);
        }
    ...
    public static class Factory {
         ...
         */
        public static RetornoObterInformacoesPessoa parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RetornoObterInformacoesPessoa object =
                    new RetornoObterInformacoesPessoa();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"RetornoObterInformacoesPessoa".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (RetornoObterInformacoesPessoa) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "NomesPapeis").equals(reader.getName())) {

                    object.setNomesPapeis(bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ArrayOfString.Factory.parse(reader));
