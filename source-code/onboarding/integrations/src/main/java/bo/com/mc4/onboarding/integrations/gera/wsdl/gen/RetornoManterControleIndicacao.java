/**
 * RetornoManterControleIndicacao.java
 * <p>
...
/**
 *  RetornoManterControleIndicacao bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class RetornoManterControleIndicacao extends bo.com.mc4.onboarding.integrations.gera.wsdl.gen.RetornoWebService
        implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
                name = RetornoManterControleIndicacao
    ...
    protected int localCodigoRetorno;
     ...
     */
    public void setCodigoRetorno(int param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                    namespacePrefix + ":RetornoManterControleIndicacao",
                    xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
        ...
        if (localCodigoRetorno == java.lang.Integer.MIN_VALUE) {

            throw new org.apache.axis2.databinding.ADBException("CodigoRetorno cannot be null!!");

        } else {
            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCodigoRetorno));
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        attribList.add(new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "RetornoManterControleIndicacao"));
        if (localMensagemErroTracker) {
        ...
        elementList.add(
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCodigoRetorno));
        if (localParametrosTracker) {
            elementList.add(new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService",
                    "Parametros"));
    ...
    public static class Factory {
         ...
         */
        public static RetornoManterControleIndicacao parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RetornoManterControleIndicacao object =
                    new RetornoManterControleIndicacao();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"RetornoManterControleIndicacao".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (RetornoManterControleIndicacao) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "CodigoRetorno").equals(reader.getName())) {
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "Parametros").equals(reader.getName())) {
