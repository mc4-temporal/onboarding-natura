...
/**
 * ObterInformacoesCep bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class ObterInformacoesCep
     ...
     * Auto generated setter method
     *
     * @param param NumeroCep
     */
    public void setNumeroCep(int param) {

        this.localNumeroCep = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":ObterInformacoesCep",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "ObterInformacoesCep",
        ...
        namespace = "http://www.geravd.com.br/Servicos/PessoaWebService";
        writeStartElement(null, namespace, "numeroCep", xmlWriter);

        if (localNumeroCep == java.lang.Integer.MIN_VALUE) {

            throw new org.apache.axis2.databinding.ADBException("numeroCep cannot be null!!");

        } else {
            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localNumeroCep));
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        elementList.add(
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localNumeroCep));
    ...
    public static class Factory {
         ...
         */
        public static ObterInformacoesCep parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ObterInformacoesCep object =
                    new ObterInformacoesCep();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ObterInformacoesCep".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ObterInformacoesCep) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "numeroCep").equals(reader.getName())) {
