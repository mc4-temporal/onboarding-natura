...
/**
 * GerarRetornarNovaSenha bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class GerarRetornarNovaSenha
        implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://www.geravd.com.br/Servicos/PessoaWebService",
            "GerarRetornarNovaSenha",
            "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":GerarRetornarNovaSenha",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "GerarRetornarNovaSenha",
    ...
    public static class Factory {
         ...
         */
        public static GerarRetornarNovaSenha parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GerarRetornarNovaSenha object =
                    new GerarRetornarNovaSenha();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GerarRetornarNovaSenha".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GerarRetornarNovaSenha) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
