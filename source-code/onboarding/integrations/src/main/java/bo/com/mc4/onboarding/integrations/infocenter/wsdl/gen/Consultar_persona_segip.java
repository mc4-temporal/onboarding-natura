...
/**
 *  Consultar_persona_segip bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class Consultar_persona_segip
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":consultar_persona_segip",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "consultar_persona_segip",
    ...
    public static class Factory {
         ...
         */
        public static Consultar_persona_segip parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            Consultar_persona_segip object =
                    new Consultar_persona_segip();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"consultar_persona_segip".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (Consultar_persona_segip) bo.com.mc4.onboarding.integrations.infocenter.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
