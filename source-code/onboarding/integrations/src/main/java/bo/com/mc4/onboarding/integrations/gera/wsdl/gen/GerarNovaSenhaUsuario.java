...
/**
 * GerarNovaSenhaUsuario bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class GerarNovaSenhaUsuario
        implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://www.geravd.com.br/Servicos/PessoaWebService",
            "GerarNovaSenhaUsuario",
            "ns1");
    ...
    protected java.lang.String localDataNascimento;
     ...
     */
    public void setDataNascimento(java.lang.String param) {
        localDataNascimentoTracker = param != null;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":GerarNovaSenhaUsuario",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "GerarNovaSenhaUsuario",
        ...
        if (localDataNascimentoTracker) {
            ...
            if (localDataNascimento == null) {
                ...
                xmlWriter.writeCharacters(localDataNascimento);
    ...
    public static class Factory {
         ...
         */
        public static GerarNovaSenhaUsuario parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GerarNovaSenhaUsuario object =
                    new GerarNovaSenhaUsuario();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GerarNovaSenhaUsuario".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GerarNovaSenhaUsuario) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
