...
/**
 * BuscarCentroDistribuicao bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class BuscarCentroDistribuicao
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":BuscarCentroDistribuicao",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "BuscarCentroDistribuicao",
    ...
    public static class Factory {
         ...
         */
        public static BuscarCentroDistribuicao parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            BuscarCentroDistribuicao object =
                    new BuscarCentroDistribuicao();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"BuscarCentroDistribuicao".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (BuscarCentroDistribuicao) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
