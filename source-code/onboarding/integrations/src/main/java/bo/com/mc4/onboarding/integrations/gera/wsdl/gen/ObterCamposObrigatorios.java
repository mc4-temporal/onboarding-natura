...
/**
 * ObterCamposObrigatorios bean class
 */
...
public class ObterCamposObrigatorios
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":ObterCamposObrigatorios",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "ObterCamposObrigatorios",
    ...
    public static class Factory {
         ...
         */
        public static ObterCamposObrigatorios parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ObterCamposObrigatorios object =
                    new ObterCamposObrigatorios();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ObterCamposObrigatorios".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ObterCamposObrigatorios) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
