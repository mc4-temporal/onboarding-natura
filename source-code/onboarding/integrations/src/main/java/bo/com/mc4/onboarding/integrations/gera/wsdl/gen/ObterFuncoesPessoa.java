...
/**
 * ObterFuncoesPessoa bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class ObterFuncoesPessoa
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":ObterFuncoesPessoa",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "ObterFuncoesPessoa",
    ...
    public static class Factory {
         ...
         */
        public static ObterFuncoesPessoa parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ObterFuncoesPessoa object =
                    new ObterFuncoesPessoa();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ObterFuncoesPessoa".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ObterFuncoesPessoa) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
