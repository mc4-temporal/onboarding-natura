/**
 * AtualizarComprovanteContrato.java
 * <p>
...
/**
 * AtualizarComprovanteContrato bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class AtualizarComprovanteContrato
        implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://www.geravd.com.br/Servicos/PessoaWebService",
            "AtualizarComprovanteContrato",
            "ns1");
    ...
    /**
     * field for SituacaoComprovante
     */


    protected int localSituacaoComprovante;
     ...
     * @return int
     */
    public int getSituacaoComprovante() {
        return localSituacaoComprovante;
    }
     ...
     * Auto generated setter method
     *
     * @param param SituacaoComprovante
     */
    public void setSituacaoComprovante(int param) {

        this.localSituacaoComprovante = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":AtualizarComprovanteContrato",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "AtualizarComprovanteContrato",
        ...
        namespace = "http://www.geravd.com.br/Servicos/PessoaWebService";
        writeStartElement(null, namespace, "situacaoComprovante", xmlWriter);

        if (localSituacaoComprovante == java.lang.Integer.MIN_VALUE) {

            throw new org.apache.axis2.databinding.ADBException("situacaoComprovante cannot be null!!");

        } else {
            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localSituacaoComprovante));
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        elementList.add(
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localSituacaoComprovante));
        if (localLoginTracker) {
            elementList.add(new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService",
                    "login"));
    ...
    public static class Factory {
         ...
         */
        public static AtualizarComprovanteContrato parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            AtualizarComprovanteContrato object =
                    new AtualizarComprovanteContrato();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"AtualizarComprovanteContrato".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (AtualizarComprovanteContrato) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "situacaoComprovante").equals(reader.getName())) {

                    java.lang.String content = reader.getElementText();

                    object.setSituacaoComprovante(
                            org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(content));
