...
/**
 * ObterSetoresIndicacao bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class ObterSetoresIndicacao
        implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://www.geravd.com.br/Servicos/PessoaWebService",
            "ObterSetoresIndicacao",
            "ns1");


    /**
     * field for CodPessoaIndicacao
     */


    protected int localCodPessoaIndicacao;
     ...
     * @return int
     */
    public int getCodPessoaIndicacao() {
        return localCodPessoaIndicacao;
    }
     ...
     *
     * @param param CodPessoaIndicacao
     */
    public void setCodPessoaIndicacao(int param) {

        this.localCodPessoaIndicacao = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":ObterSetoresIndicacao",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "ObterSetoresIndicacao",
        ...
        writeStartElement(null, namespace, "codPessoaIndicacao", xmlWriter);

        if (localCodPessoaIndicacao == java.lang.Integer.MIN_VALUE) {

            throw new org.apache.axis2.databinding.ADBException("codPessoaIndicacao cannot be null!!");

        } else {
            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCodPessoaIndicacao));
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        elementList.add(
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCodPessoaIndicacao));
        if (localCepTracker) {
            elementList.add(new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService",
                    "cep"));
    ...
    public static class Factory {
         ...
         */
        public static ObterSetoresIndicacao parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ObterSetoresIndicacao object =
                    new ObterSetoresIndicacao();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ObterSetoresIndicacao".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ObterSetoresIndicacao) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "codPessoaIndicacao").equals(reader.getName())) {

                    java.lang.String content = reader.getElementText();

                    object.setCodPessoaIndicacao(
