...
/**
 *  Consultar_persona_motor bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class Consultar_persona_motor
    ...
    /**
     * field for Datos_motor_decision
     */


    protected java.lang.String localDatos_motor_decision;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localDatos_motor_decisionTracker = false;

    public boolean isDatos_motor_decisionSpecified() {
        return localDatos_motor_decisionTracker;
    }
     ...
     * @return java.lang.String
     */
    public java.lang.String getDatos_motor_decision() {
        return localDatos_motor_decision;
    }


    /**
     * Auto generated setter method
     * @param param Datos_motor_decision
     */
    public void setDatos_motor_decision(java.lang.String param) {
        localDatos_motor_decisionTracker = param != null;

        this.localDatos_motor_decision = param;
    ...
    /**
     * field for Tipo_reporte
     */


    protected java.lang.String localTipo_reporte;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localTipo_reporteTracker = false;

    public boolean isTipo_reporteSpecified() {
        return localTipo_reporteTracker;
    }
    ...
    public java.lang.String getTipo_reporte() {
        return localTipo_reporte;
    }


    /**
     * Auto generated setter method
     * @param param Tipo_reporte
     */
    public void setTipo_reporte(java.lang.String param) {
        localTipo_reporteTracker = param != null;

        this.localTipo_reporte = param;
    ...
    /**
     * field for Integracion
     */


    protected int localIntegracion;
    ...
    public int getIntegracion() {
        return localIntegracion;
    }


    /**
     * Auto generated setter method
     * @param param Integracion
     */
    public void setIntegracion(int param) {

        this.localIntegracion = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":consultar_persona_motor",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "consultar_persona_motor",
        ...
        if (localDatos_motor_decisionTracker) {
            namespace = "http://tempuri.org/Enserbic_WS/Service1";
            writeStartElement(null, namespace, "datos_motor_decision", xmlWriter);


            if (localDatos_motor_decision == null) {
                // write the nil attribute

                throw new org.apache.axis2.databinding.ADBException("datos_motor_decision cannot be null!!");

            } else {


                xmlWriter.writeCharacters(localDatos_motor_decision);
        ...
        if (localTipo_reporteTracker) {
            namespace = "http://tempuri.org/Enserbic_WS/Service1";
            writeStartElement(null, namespace, "tipo_reporte", xmlWriter);


            if (localTipo_reporte == null) {
                // write the nil attribute

                throw new org.apache.axis2.databinding.ADBException("tipo_reporte cannot be null!!");

            } else {


                xmlWriter.writeCharacters(localTipo_reporte);
        ...
        namespace = "http://tempuri.org/Enserbic_WS/Service1";
        writeStartElement(null, namespace, "integracion", xmlWriter);

        if (localIntegracion == java.lang.Integer.MIN_VALUE) {

            throw new org.apache.axis2.databinding.ADBException("integracion cannot be null!!");

        } else {
            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localIntegracion));
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (localDatos_motor_decisionTracker) {
            elementList.add(new javax.xml.namespace.QName("http://tempuri.org/Enserbic_WS/Service1",
                    "datos_motor_decision"));

            if (localDatos_motor_decision != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localDatos_motor_decision));
            } else {
                throw new org.apache.axis2.databinding.ADBException("datos_motor_decision cannot be null!!");
            }
        }
        ...
        if (localTipo_reporteTracker) {
            ...
            if (localTipo_reporte != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localTipo_reporte));
            } else {
                throw new org.apache.axis2.databinding.ADBException("tipo_reporte cannot be null!!");
            }
        }
        ...
        elementList.add(
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localIntegracion));
    ...
    public static class Factory {
         ...
         */
        public static Consultar_persona_motor parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            Consultar_persona_motor object =
                    new Consultar_persona_motor();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"consultar_persona_motor".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (Consultar_persona_motor) bo.com.mc4.onboarding.integrations.infocenter.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://tempuri.org/Enserbic_WS/Service1", "datos_motor_decision").equals(reader.getName())) {

                    java.lang.String content = reader.getElementText();

                    object.setDatos_motor_decision(
                            org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://tempuri.org/Enserbic_WS/Service1", "tipo_reporte").equals(reader.getName())) {

                    java.lang.String content = reader.getElementText();

                    object.setTipo_reporte(
                            org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://tempuri.org/Enserbic_WS/Service1", "integracion").equals(reader.getName())) {

                    java.lang.String content = reader.getElementText();

                    object.setIntegracion(
