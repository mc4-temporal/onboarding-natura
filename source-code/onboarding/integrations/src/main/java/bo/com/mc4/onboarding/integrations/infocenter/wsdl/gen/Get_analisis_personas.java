...
/**
 *  Get_analisis_personas bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class Get_analisis_personas
    ...
    protected java.lang.String localNro_envio;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localNro_envioTracker = false;

    public boolean isNro_envioSpecified() {
        return localNro_envioTracker;
    }
     ...
     * @return java.lang.String
     */
    public java.lang.String getNro_envio() {
        return localNro_envio;
    }


    /**
     * Auto generated setter method
     * @param param Nro_envio
     */
    public void setNro_envio(java.lang.String param) {
        localNro_envioTracker = param != null;

        this.localNro_envio = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":Get_analisis_personas",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "Get_analisis_personas",
        ...
        if (localNro_envioTracker) {
            namespace = "http://tempuri.org/Enserbic_WS/Service1";
            writeStartElement(null, namespace, "nro_envio", xmlWriter);


            if (localNro_envio == null) {
                // write the nil attribute

                throw new org.apache.axis2.databinding.ADBException("nro_envio cannot be null!!");

            } else {


                xmlWriter.writeCharacters(localNro_envio);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (localNro_envioTracker) {
            ...
            if (localNro_envio != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localNro_envio));
            } else {
                throw new org.apache.axis2.databinding.ADBException("nro_envio cannot be null!!");
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static Get_analisis_personas parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            Get_analisis_personas object =
                    new Get_analisis_personas();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Get_analisis_personas".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (Get_analisis_personas) bo.com.mc4.onboarding.integrations.infocenter.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://tempuri.org/Enserbic_WS/Service1", "nro_envio").equals(reader.getName())) {
