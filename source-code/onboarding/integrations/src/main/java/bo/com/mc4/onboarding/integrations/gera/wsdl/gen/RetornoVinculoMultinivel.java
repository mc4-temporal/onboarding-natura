...
/**
 * RetornoVinculoMultinivel bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class RetornoVinculoMultinivel extends bo.com.mc4.onboarding.integrations.gera.wsdl.gen.RetornoWebService
        implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
                name = RetornoVinculoMultinivel
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                    namespacePrefix + ":RetornoVinculoMultinivel",
                    xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "RetornoVinculoMultinivel",
                    xmlWriter);
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        attribList.add(new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "RetornoVinculoMultinivel"));
        if (localMensagemErroTracker) {
    ...
    public static class Factory {
         ...
         */
        public static RetornoVinculoMultinivel parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RetornoVinculoMultinivel object =
                    new RetornoVinculoMultinivel();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"RetornoVinculoMultinivel".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (RetornoVinculoMultinivel) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
