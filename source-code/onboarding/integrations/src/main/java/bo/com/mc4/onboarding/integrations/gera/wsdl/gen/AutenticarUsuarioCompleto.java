/**
 * AutenticarUsuarioCompleto.java
 * <p>
...
/**
 * AutenticarUsuarioCompleto bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class AutenticarUsuarioCompleto
        implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://www.geravd.com.br/Servicos/PessoaWebService",
            "AutenticarUsuarioCompleto",
            "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":AutenticarUsuarioCompleto",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "AutenticarUsuarioCompleto",
    ...
    public static class Factory {
         ...
         */
        public static AutenticarUsuarioCompleto parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            AutenticarUsuarioCompleto object =
                    new AutenticarUsuarioCompleto();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"AutenticarUsuarioCompleto".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (AutenticarUsuarioCompleto) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
