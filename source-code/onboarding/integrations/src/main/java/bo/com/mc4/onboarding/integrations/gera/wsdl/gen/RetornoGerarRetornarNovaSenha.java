/**
 * RetornoGerarRetornarNovaSenha.java
 * <p>
...
/**
 *  RetornoGerarRetornarNovaSenha bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class RetornoGerarRetornarNovaSenha extends bo.com.mc4.onboarding.integrations.gera.wsdl.gen.RetornoWebService
        implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
                name = RetornoGerarRetornarNovaSenha
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                    namespacePrefix + ":RetornoGerarRetornarNovaSenha",
                    xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "RetornoGerarRetornarNovaSenha",
                    xmlWriter);
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        attribList.add(new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "RetornoGerarRetornarNovaSenha"));
        if (localMensagemErroTracker) {
    ...
    public static class Factory {
         ...
         */
        public static RetornoGerarRetornarNovaSenha parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RetornoGerarRetornarNovaSenha object =
                    new RetornoGerarRetornarNovaSenha();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"RetornoGerarRetornarNovaSenha".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (RetornoGerarRetornarNovaSenha) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
