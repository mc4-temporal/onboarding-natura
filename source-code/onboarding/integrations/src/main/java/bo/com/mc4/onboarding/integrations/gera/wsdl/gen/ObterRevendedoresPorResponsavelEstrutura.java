/**
 * ObterRevendedoresPorResponsavelEstrutura.java
 * <p>
...
/**
 *  ObterRevendedoresPorResponsavelEstrutura bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class ObterRevendedoresPorResponsavelEstrutura
        implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://www.geravd.com.br/Servicos/PessoaWebService",
            "ObterRevendedoresPorResponsavelEstrutura",
            "ns1");


    /**
     * field for CodigoResponsavel
     */


    protected int localCodigoResponsavel;
    ...
    public int getCodigoResponsavel() {
        return localCodigoResponsavel;
    }


    /**
     * Auto generated setter method
     * @param param CodigoResponsavel
     */
    public void setCodigoResponsavel(int param) {

        this.localCodigoResponsavel = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":ObterRevendedoresPorResponsavelEstrutura",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "ObterRevendedoresPorResponsavelEstrutura",
        ...
        writeStartElement(null, namespace, "codigoResponsavel", xmlWriter);

        if (localCodigoResponsavel == java.lang.Integer.MIN_VALUE) {

            throw new org.apache.axis2.databinding.ADBException("codigoResponsavel cannot be null!!");

        } else {
            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCodigoResponsavel));
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        elementList.add(
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCodigoResponsavel));
        if (localLoginTracker) {
            elementList.add(new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService",
                    "login"));
    ...
    public static class Factory {
         ...
         */
        public static ObterRevendedoresPorResponsavelEstrutura parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ObterRevendedoresPorResponsavelEstrutura object =
                    new ObterRevendedoresPorResponsavelEstrutura();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ObterRevendedoresPorResponsavelEstrutura".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ObterRevendedoresPorResponsavelEstrutura) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "codigoResponsavel").equals(reader.getName())) {

                    java.lang.String content = reader.getElementText();

                    object.setCodigoResponsavel(
