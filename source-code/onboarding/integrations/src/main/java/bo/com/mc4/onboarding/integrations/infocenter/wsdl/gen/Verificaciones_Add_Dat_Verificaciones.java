/**
 * Verificaciones_Add_Dat_Verificaciones.java
 * <p>
...
/**
 *  Verificaciones_Add_Dat_Verificaciones bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class Verificaciones_Add_Dat_Verificaciones
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":Verificaciones_Add_Dat_Verificaciones",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "Verificaciones_Add_Dat_Verificaciones",
    ...
    public static class Factory {
         ...
         */
        public static Verificaciones_Add_Dat_Verificaciones parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            Verificaciones_Add_Dat_Verificaciones object =
                    new Verificaciones_Add_Dat_Verificaciones();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Verificaciones_Add_Dat_Verificaciones".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (Verificaciones_Add_Dat_Verificaciones) bo.com.mc4.onboarding.integrations.infocenter.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
