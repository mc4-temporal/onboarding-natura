...
/**
 * ObterPapeis bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class ObterPapeis
    ...
    public static class Factory {
         ...
         */
        public static ObterPapeis parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ObterPapeis object =
                    new ObterPapeis();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ObterPapeis".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ObterPapeis) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
