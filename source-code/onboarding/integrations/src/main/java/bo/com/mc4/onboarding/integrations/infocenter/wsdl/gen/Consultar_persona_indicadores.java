/**
 * Consultar_persona_indicadores.java
 * <p>
...
/**
 *  Consultar_persona_indicadores bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class Consultar_persona_indicadores
    ...
    /**
     * field for Xml_entrada
     */


    protected java.lang.String localXml_entrada;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localXml_entradaTracker = false;

    public boolean isXml_entradaSpecified() {
        return localXml_entradaTracker;
    }
     ...
     * @return java.lang.String
     */
    public java.lang.String getXml_entrada() {
        return localXml_entrada;
    }


    /**
     * Auto generated setter method
     * @param param Xml_entrada
     */
    public void setXml_entrada(java.lang.String param) {
        localXml_entradaTracker = param != null;

        this.localXml_entrada = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":consultar_persona_indicadores",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "consultar_persona_indicadores",
        ...
        if (localXml_entradaTracker) {
            namespace = "http://tempuri.org/Enserbic_WS/Service1";
            writeStartElement(null, namespace, "xml_entrada", xmlWriter);


            if (localXml_entrada == null) {
                // write the nil attribute

                throw new org.apache.axis2.databinding.ADBException("xml_entrada cannot be null!!");

            } else {


                xmlWriter.writeCharacters(localXml_entrada);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (localXml_entradaTracker) {
            ...
            if (localXml_entrada != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localXml_entrada));
            } else {
                throw new org.apache.axis2.databinding.ADBException("xml_entrada cannot be null!!");
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static Consultar_persona_indicadores parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            Consultar_persona_indicadores object =
                    new Consultar_persona_indicadores();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"consultar_persona_indicadores".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (Consultar_persona_indicadores) bo.com.mc4.onboarding.integrations.infocenter.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://tempuri.org/Enserbic_WS/Service1", "xml_entrada").equals(reader.getName())) {

                    java.lang.String content = reader.getElementText();

                    object.setXml_entrada(
                            org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
