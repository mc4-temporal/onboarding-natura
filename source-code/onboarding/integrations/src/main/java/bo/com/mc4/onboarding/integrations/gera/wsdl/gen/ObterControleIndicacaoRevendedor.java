/**
 * ObterControleIndicacaoRevendedor.java
 * <p>
...
/**
 *  ObterControleIndicacaoRevendedor bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class ObterControleIndicacaoRevendedor
        implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://www.geravd.com.br/Servicos/PessoaWebService",
            "ObterControleIndicacaoRevendedor",
            "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":ObterControleIndicacaoRevendedor",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "ObterControleIndicacaoRevendedor",
    ...
    public static class Factory {
         ...
         */
        public static ObterControleIndicacaoRevendedor parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ObterControleIndicacaoRevendedor object =
                    new ObterControleIndicacaoRevendedor();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ObterControleIndicacaoRevendedor".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ObterControleIndicacaoRevendedor) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
