/**
 * Consultar_contrastacion_segip.java
 * <p>
...
/**
 *  Consultar_contrastacion_segip bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class Consultar_contrastacion_segip
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":consultar_contrastacion_segip",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "consultar_contrastacion_segip",
    ...
    public static class Factory {
         ...
         */
        public static Consultar_contrastacion_segip parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            Consultar_contrastacion_segip object =
                    new Consultar_contrastacion_segip();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"consultar_contrastacion_segip".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (Consultar_contrastacion_segip) bo.com.mc4.onboarding.integrations.infocenter.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
