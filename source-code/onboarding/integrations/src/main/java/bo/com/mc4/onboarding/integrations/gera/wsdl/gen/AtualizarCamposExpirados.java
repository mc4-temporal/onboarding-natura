...
/**
 * AtualizarCamposExpirados bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class AtualizarCamposExpirados
        implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://www.geravd.com.br/Servicos/PessoaWebService",
            "AtualizarCamposExpirados",
            "ns1");
    ...
    protected bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ArrayOfParametroAtualizacaoCampoExpiravel localCampos;
    ...
    public boolean isCamposSpecified() {
        return localCamposTracker;
    }
     ...
     * Auto generated getter method
     *
     * @return bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ArrayOfParametroAtualizacaoCampoExpiravel
     */
    public bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ArrayOfParametroAtualizacaoCampoExpiravel getCampos() {
        return localCampos;
    }
     ...
     * @param param Campos
     */
    public void setCampos(bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ArrayOfParametroAtualizacaoCampoExpiravel param) {
        localCamposTracker = param != null;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":AtualizarCamposExpirados",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "AtualizarCamposExpirados",
        ...
        if (localCamposTracker) {
            ...
            localCampos.serialize(new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "campos"),
                    xmlWriter);
        }
    ...
    public static class Factory {
         ...
         */
        public static AtualizarCamposExpirados parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            AtualizarCamposExpirados object =
                    new AtualizarCamposExpirados();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"AtualizarCamposExpirados".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (AtualizarCamposExpirados) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "campos").equals(reader.getName())) {

                    object.setCampos(bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ArrayOfParametroAtualizacaoCampoExpiravel.Factory.parse(reader));
