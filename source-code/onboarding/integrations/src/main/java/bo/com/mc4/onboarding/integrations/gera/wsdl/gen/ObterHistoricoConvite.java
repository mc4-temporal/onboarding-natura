...
/**
 * ObterHistoricoConvite bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class ObterHistoricoConvite
        implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://www.geravd.com.br/Servicos/PessoaWebService",
            "ObterHistoricoConvite",
            "ns1");
    ...
    /**
     * field for PrazoConsulta
     */


    protected int localPrazoConsulta;
     ...
     * @return int
     */
    public int getPrazoConsulta() {
        return localPrazoConsulta;
    }
     ...
     * Auto generated setter method
     *
     * @param param PrazoConsulta
     */
    public void setPrazoConsulta(int param) {

        this.localPrazoConsulta = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":ObterHistoricoConvite",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "ObterHistoricoConvite",
        ...
        namespace = "http://www.geravd.com.br/Servicos/PessoaWebService";
        writeStartElement(null, namespace, "prazoConsulta", xmlWriter);

        if (localPrazoConsulta == java.lang.Integer.MIN_VALUE) {

            throw new org.apache.axis2.databinding.ADBException("prazoConsulta cannot be null!!");

        } else {
            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localPrazoConsulta));
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        elementList.add(
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localPrazoConsulta));
        if (localLoginTracker) {
            elementList.add(new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService",
                    "login"));
    ...
    public static class Factory {
         ...
         */
        public static ObterHistoricoConvite parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ObterHistoricoConvite object =
                    new ObterHistoricoConvite();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ObterHistoricoConvite".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ObterHistoricoConvite) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "prazoConsulta").equals(reader.getName())) {

                    java.lang.String content = reader.getElementText();

                    object.setPrazoConsulta(
                            org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(content));
