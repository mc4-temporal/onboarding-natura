...
/**
 * GravaDocumentoPessoa bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class GravaDocumentoPessoa
        implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://www.geravd.com.br/Servicos/PessoaWebService",
            "GravaDocumentoPessoa",
            "ns1");
    ...
    protected org.apache.axis2.databinding.types.UnsignedByte localTipoDocumento;
     ...
     */
    public org.apache.axis2.databinding.types.UnsignedByte getTipoDocumento() {
     ...
     */
    public void setTipoDocumento(org.apache.axis2.databinding.types.UnsignedByte param) {
    ...
    /**
     * field for ArquivoDocumento
     */


    protected javax.activation.DataHandler localArquivoDocumento;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localArquivoDocumentoTracker = false;

    public boolean isArquivoDocumentoSpecified() {
        return localArquivoDocumentoTracker;
    }
     ...
     */
    public javax.activation.DataHandler getArquivoDocumento() {
        return localArquivoDocumento;
    }
     ...
     * Auto generated setter method
     *
     * @param param ArquivoDocumento
     */
    public void setArquivoDocumento(javax.activation.DataHandler param) {
        localArquivoDocumentoTracker = param != null;

        this.localArquivoDocumento = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":GravaDocumentoPessoa",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "GravaDocumentoPessoa",
        ...
        xmlWriter.writeEndElement();
        if (localArquivoDocumentoTracker) {
            namespace = "http://www.geravd.com.br/Servicos/PessoaWebService";
            writeStartElement(null, namespace, "arquivoDocumento", xmlWriter);


            if (localArquivoDocumento != null) {
                try {
                    org.apache.axiom.util.stax.XMLStreamWriterUtils.writeDataHandler(xmlWriter, localArquivoDocumento, null, true);
                } catch (java.io.IOException ex) {
                    throw new javax.xml.stream.XMLStreamException("Unable to read data handler for arquivoDocumento", ex);
                }
            } else {
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (localArquivoDocumentoTracker) {
            ...
            elementList.add(localArquivoDocumento);
        }
        if (localObservacaoTracker) {
            elementList.add(new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService",
                    "observacao"));
    ...
    public static class Factory {
         ...
         */
        public static GravaDocumentoPessoa parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GravaDocumentoPessoa object =
                    new GravaDocumentoPessoa();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GravaDocumentoPessoa".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GravaDocumentoPessoa) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "arquivoDocumento").equals(reader.getName())) {

                    object.setArquivoDocumento(org.apache.axiom.util.stax.XMLStreamReaderUtils.getDataHandlerFromElement(reader));
