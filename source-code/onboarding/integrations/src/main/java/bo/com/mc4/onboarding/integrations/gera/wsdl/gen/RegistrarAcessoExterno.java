...
/**
 * RegistrarAcessoExterno bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class RegistrarAcessoExterno
        implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://www.geravd.com.br/Servicos/PessoaWebService",
            "RegistrarAcessoExterno",
            "ns1");
    ...
    /**
     * field for DataHoraAcesso
     */


    protected java.util.Calendar localDataHoraAcesso;
     ...
     */
    public java.util.Calendar getDataHoraAcesso() {
        return localDataHoraAcesso;
    }
     ...
     * Auto generated setter method
     *
     * @param param DataHoraAcesso
     */
    public void setDataHoraAcesso(java.util.Calendar param) {

        this.localDataHoraAcesso = param;
    ...
    protected java.lang.String localOperacao;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localOperacaoTracker = false;

    public boolean isOperacaoSpecified() {
        return localOperacaoTracker;
    }
     ...
     */
    public void setOperacao(java.lang.String param) {
        localOperacaoTracker = param != null;

        this.localOperacao = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":RegistrarAcessoExterno",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "RegistrarAcessoExterno",
        ...
        namespace = "http://www.geravd.com.br/Servicos/PessoaWebService";
        writeStartElement(null, namespace, "dataHoraAcesso", xmlWriter);


        if (localDataHoraAcesso == null) {
            // write the nil attribute

            throw new org.apache.axis2.databinding.ADBException("dataHoraAcesso cannot be null!!");

        } else {


            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localDataHoraAcesso));

        }

        xmlWriter.writeEndElement();
        if (localOperacaoTracker) {
            namespace = "http://www.geravd.com.br/Servicos/PessoaWebService";
            writeStartElement(null, namespace, "operacao", xmlWriter);


            if (localOperacao == null) {
                // write the nil attribute

                throw new org.apache.axis2.databinding.ADBException("operacao cannot be null!!");

            } else {


                xmlWriter.writeCharacters(localOperacao);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (localDataHoraAcesso != null) {
            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localDataHoraAcesso));
        } else {
            throw new org.apache.axis2.databinding.ADBException("dataHoraAcesso cannot be null!!");
        }
        if (localOperacaoTracker) {
            ...
            if (localOperacao != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localOperacao));
            } else {
                throw new org.apache.axis2.databinding.ADBException("operacao cannot be null!!");
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static RegistrarAcessoExterno parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RegistrarAcessoExterno object =
                    new RegistrarAcessoExterno();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"RegistrarAcessoExterno".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (RegistrarAcessoExterno) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "ip").equals(reader.getName())) {
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "dataHoraAcesso").equals(reader.getName())) {

                    java.lang.String content = reader.getElementText();

                    object.setDataHoraAcesso(
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "operacao").equals(reader.getName())) {
