...
/**
 * ObterRedeIndicacao bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class ObterRedeIndicacao
    ...
    /**
     * field for NivelLimite
     */


    protected int localNivelLimite;
     ...
     * @return int
     */
    public int getNivelLimite() {
        return localNivelLimite;
    }
     ...
     * Auto generated setter method
     *
     * @param param NivelLimite
     */
    public void setNivelLimite(int param) {

        this.localNivelLimite = param;
    ...
    /**
     * field for SituacaoPessoa
     */


    protected bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ArrayOfInt localSituacaoPessoa;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localSituacaoPessoaTracker = false;

    public boolean isSituacaoPessoaSpecified() {
        return localSituacaoPessoaTracker;
    }
     ...
     */
    public bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ArrayOfInt getSituacaoPessoa() {
        return localSituacaoPessoa;
    }
     ...
     * Auto generated setter method
     *
     * @param param SituacaoPessoa
     */
    public void setSituacaoPessoa(bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ArrayOfInt param) {
        localSituacaoPessoaTracker = param != null;

        this.localSituacaoPessoa = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":ObterRedeIndicacao",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "ObterRedeIndicacao",
        ...
        namespace = "http://www.geravd.com.br/Servicos/PessoaWebService";
        writeStartElement(null, namespace, "nivelLimite", xmlWriter);

        if (localNivelLimite == java.lang.Integer.MIN_VALUE) {

            throw new org.apache.axis2.databinding.ADBException("nivelLimite cannot be null!!");

        } else {
            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localNivelLimite));
        }
        ...
        xmlWriter.writeEndElement();
        if (localSituacaoPessoaTracker) {
            if (localSituacaoPessoa == null) {
                throw new org.apache.axis2.databinding.ADBException("situacaoPessoa cannot be null!!");
            }
            localSituacaoPessoa.serialize(new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "situacaoPessoa"),
                    xmlWriter);
        }
        xmlWriter.writeEndElement();
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        elementList.add(
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localNivelLimite));
        ...
        if (localSituacaoPessoaTracker) {
            ...
            elementList.add(localSituacaoPessoa);
        }
    ...
    public static class Factory {
         ...
         */
        public static ObterRedeIndicacao parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ObterRedeIndicacao object =
                    new ObterRedeIndicacao();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ObterRedeIndicacao".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ObterRedeIndicacao) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "nivelLimite").equals(reader.getName())) {

                    java.lang.String content = reader.getElementText();

                    object.setNivelLimite(
                            org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(content));
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "situacaoPessoa").equals(reader.getName())) {

                    object.setSituacaoPessoa(bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ArrayOfInt.Factory.parse(reader));
