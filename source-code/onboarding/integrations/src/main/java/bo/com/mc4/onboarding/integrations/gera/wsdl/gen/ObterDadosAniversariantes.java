/**
 * ObterDadosAniversariantes.java
 * <p>
...
/**
 * ObterDadosAniversariantes bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class ObterDadosAniversariantes
        implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://www.geravd.com.br/Servicos/PessoaWebService",
            "ObterDadosAniversariantes",
            "ns1");
    ...
    /**
     * field for DataInicial
     */


    protected java.util.Calendar localDataInicial;
     ...
     * Auto generated setter method
     *
     * @param param DataInicial
     */
    public void setDataInicial(java.util.Calendar param) {

        this.localDataInicial = param;
    ...
    protected java.util.Calendar localDataFinal;
     ...
     * Auto generated setter method
     *
     * @param param DataFinal
     */
    public void setDataFinal(java.util.Calendar param) {

        this.localDataFinal = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":ObterDadosAniversariantes",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "ObterDadosAniversariantes",
        ...
        namespace = "http://www.geravd.com.br/Servicos/PessoaWebService";
        writeStartElement(null, namespace, "dataInicial", xmlWriter);


        if (localDataInicial == null) {
            // write the nil attribute

            throw new org.apache.axis2.databinding.ADBException("dataInicial cannot be null!!");

        } else {


            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localDataInicial));
        ...
        namespace = "http://www.geravd.com.br/Servicos/PessoaWebService";
        writeStartElement(null, namespace, "dataFinal", xmlWriter);


        if (localDataFinal == null) {
            // write the nil attribute

            throw new org.apache.axis2.databinding.ADBException("dataFinal cannot be null!!");

        } else {


            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localDataFinal));
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (localDataInicial != null) {
            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localDataInicial));
        } else {
            throw new org.apache.axis2.databinding.ADBException("dataInicial cannot be null!!");
        }
        ...
        if (localDataFinal != null) {
            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localDataFinal));
        } else {
            throw new org.apache.axis2.databinding.ADBException("dataFinal cannot be null!!");
        }
    ...
    public static class Factory {
         ...
         */
        public static ObterDadosAniversariantes parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ObterDadosAniversariantes object =
                    new ObterDadosAniversariantes();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ObterDadosAniversariantes".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ObterDadosAniversariantes) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "dataInicial").equals(reader.getName())) {

                    java.lang.String content = reader.getElementText();

                    object.setDataInicial(
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "dataFinal").equals(reader.getName())) {
