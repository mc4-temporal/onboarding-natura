/**
 * RetornoObterEventosAgendaRevendedora.java
 * <p>
...
/**
 *  RetornoObterEventosAgendaRevendedora bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class RetornoObterEventosAgendaRevendedora extends bo.com.mc4.onboarding.integrations.gera.wsdl.gen.RetornoWebService
        implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
                name = RetornoObterEventosAgendaRevendedora
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                    namespacePrefix + ":RetornoObterEventosAgendaRevendedora",
                    xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        attribList.add(new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "RetornoObterEventosAgendaRevendedora"));
        if (localMensagemErroTracker) {
    ...
    public static class Factory {
         ...
         */
        public static RetornoObterEventosAgendaRevendedora parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RetornoObterEventosAgendaRevendedora object =
                    new RetornoObterEventosAgendaRevendedora();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"RetornoObterEventosAgendaRevendedora".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (RetornoObterEventosAgendaRevendedora) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
