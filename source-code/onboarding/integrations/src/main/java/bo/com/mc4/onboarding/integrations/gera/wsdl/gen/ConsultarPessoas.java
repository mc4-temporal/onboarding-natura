...
public class ConsultarPessoas
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":ConsultarPessoas",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "ConsultarPessoas",
    ...
    public static class Factory {
         ...
         */
        public static ConsultarPessoas parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ConsultarPessoas object =
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ConsultarPessoas".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ConsultarPessoas) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "codigoPessoa").equals(reader.getName())) {
                    ...
                    if (!"true".equals(nillableValue) && !"1".equals(nillableValue)) {
                        ...
                        object.setCodigoPessoa(java.lang.Integer.MIN_VALUE);
