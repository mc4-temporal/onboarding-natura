...
public class ValidarConsultor
    ...
    /**
     * field for CodigoOuCpf
     */


    protected java.lang.String localCodigoOuCpf;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localCodigoOuCpfTracker = false;

    public boolean isCodigoOuCpfSpecified() {
        return localCodigoOuCpfTracker;
    }
     ...
     */
    public java.lang.String getCodigoOuCpf() {
        return localCodigoOuCpf;
    }
     ...
     *
     * @param param CodigoOuCpf
     */
    public void setCodigoOuCpf(java.lang.String param) {
        localCodigoOuCpfTracker = param != null;

        this.localCodigoOuCpf = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":ValidarConsultor",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "ValidarConsultor",
        ...
        if (localCodigoOuCpfTracker) {
            namespace = "http://www.geravd.com.br/Servicos/PessoaWebService";
            writeStartElement(null, namespace, "codigoOuCpf", xmlWriter);


            if (localCodigoOuCpf == null) {
                // write the nil attribute

                throw new org.apache.axis2.databinding.ADBException("codigoOuCpf cannot be null!!");

            } else {


                xmlWriter.writeCharacters(localCodigoOuCpf);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (localCodigoOuCpfTracker) {
            ...
            if (localCodigoOuCpf != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCodigoOuCpf));
            } else {
                throw new org.apache.axis2.databinding.ADBException("codigoOuCpf cannot be null!!");
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ValidarConsultor parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ValidarConsultor object =
                    new ValidarConsultor();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ValidarConsultor".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ValidarConsultor) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "codigoOuCpf").equals(reader.getName())) {

                    java.lang.String content = reader.getElementText();

                    object.setCodigoOuCpf(
