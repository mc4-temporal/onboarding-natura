/**
 * RecuperarSenhaPerguntaSecreta.java
 * <p>
...
/**
 *  RecuperarSenhaPerguntaSecreta bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class RecuperarSenhaPerguntaSecreta
        implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://www.geravd.com.br/Servicos/PessoaWebService",
            "RecuperarSenhaPerguntaSecreta",
            "ns1");


    /**
     * field for CodigoEmailCPF
     */


    protected java.lang.String localCodigoEmailCPF;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localCodigoEmailCPFTracker = false;

    public boolean isCodigoEmailCPFSpecified() {
        return localCodigoEmailCPFTracker;
    }
     ...
     */
    public java.lang.String getCodigoEmailCPF() {
        return localCodigoEmailCPF;
    }


    /**
     * Auto generated setter method
     * @param param CodigoEmailCPF
     */
    public void setCodigoEmailCPF(java.lang.String param) {
        localCodigoEmailCPFTracker = param != null;

        this.localCodigoEmailCPF = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":RecuperarSenhaPerguntaSecreta",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "RecuperarSenhaPerguntaSecreta",
        ...
        if (localCodigoEmailCPFTracker) {
            namespace = "http://www.geravd.com.br/Servicos/PessoaWebService";
            writeStartElement(null, namespace, "codigoEmailCPF", xmlWriter);


            if (localCodigoEmailCPF == null) {
                // write the nil attribute

                throw new org.apache.axis2.databinding.ADBException("codigoEmailCPF cannot be null!!");

            } else {


                xmlWriter.writeCharacters(localCodigoEmailCPF);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (localCodigoEmailCPFTracker) {
            ...
            if (localCodigoEmailCPF != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCodigoEmailCPF));
            } else {
                throw new org.apache.axis2.databinding.ADBException("codigoEmailCPF cannot be null!!");
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static RecuperarSenhaPerguntaSecreta parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RecuperarSenhaPerguntaSecreta object =
                    new RecuperarSenhaPerguntaSecreta();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"RecuperarSenhaPerguntaSecreta".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (RecuperarSenhaPerguntaSecreta) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "codigoEmailCPF").equals(reader.getName())) {

                    java.lang.String content = reader.getElementText();

                    object.setCodigoEmailCPF(
