/**
 * ObterLucratividadePeriodo.java
 * <p>
...
/**
 * ObterLucratividadePeriodo bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class ObterLucratividadePeriodo
        implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
            "http://www.geravd.com.br/Servicos/PessoaWebService",
            "ObterLucratividadePeriodo",
            "ns1");
    ...
    protected java.lang.String localCampanhaInicio;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localCampanhaInicioTracker = false;

    public boolean isCampanhaInicioSpecified() {
        return localCampanhaInicioTracker;
    }
     ...
     * @return java.lang.String
     */
    public java.lang.String getCampanhaInicio() {
     ...
     */
    public void setCampanhaInicio(java.lang.String param) {
        localCampanhaInicioTracker = param != null;
    ...
    protected java.lang.String localCampanhaFim;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localCampanhaFimTracker = false;

    public boolean isCampanhaFimSpecified() {
        return localCampanhaFimTracker;
    }
     ...
     * @return java.lang.String
     */
    public java.lang.String getCampanhaFim() {
     ...
     */
    public void setCampanhaFim(java.lang.String param) {
        localCampanhaFimTracker = param != null;
    ...
    protected java.lang.String localAno;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localAnoTracker = false;

    public boolean isAnoSpecified() {
        return localAnoTracker;
    }
     ...
     * @param param Ano
     */
    public void setAno(java.lang.String param) {
        localAnoTracker = param != null;
    ...
    protected java.lang.String localDataInicio;
     ...
     */
    public void setDataInicio(java.lang.String param) {
        localDataInicioTracker = param != null;
    ...
    protected java.lang.String localDataFim;
     ...
     * @param param DataFim
     */
    public void setDataFim(java.lang.String param) {
        localDataFimTracker = param != null;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":ObterLucratividadePeriodo",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "ObterLucratividadePeriodo",
        ...
        if (localCampanhaInicioTracker) {
            ...
            if (localCampanhaInicio == null) {
                ...
                xmlWriter.writeCharacters(localCampanhaInicio);

            }

            xmlWriter.writeEndElement();
        }
        if (localCampanhaFimTracker) {
            namespace = "http://www.geravd.com.br/Servicos/PessoaWebService";
            writeStartElement(null, namespace, "campanhaFim", xmlWriter);


            if (localCampanhaFim == null) {
                // write the nil attribute
                ...
                xmlWriter.writeCharacters(localCampanhaFim);
        ...
        if (localAnoTracker) {
            ...
            if (localAno == null) {
                ...
                xmlWriter.writeCharacters(localAno);
        ...
        if (localDataInicioTracker) {
            ...
            if (localDataInicio == null) {
                ...
                xmlWriter.writeCharacters(localDataInicio);
        ...
        if (localDataFimTracker) {
            ...
            if (localDataFim == null) {
                ...
                xmlWriter.writeCharacters(localDataFim);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (localCampanhaInicioTracker) {
            ...
            if (localCampanhaInicio != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCampanhaInicio));
            } else {
                throw new org.apache.axis2.databinding.ADBException("campanhaInicio cannot be null!!");
            }
        }
        if (localCampanhaFimTracker) {
            ...
            if (localCampanhaFim != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCampanhaFim));
            } else {
                throw new org.apache.axis2.databinding.ADBException("campanhaFim cannot be null!!");
            }
        }
        if (localAnoTracker) {
            ...
            if (localAno != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localAno));
            } else {
                throw new org.apache.axis2.databinding.ADBException("ano cannot be null!!");
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ObterLucratividadePeriodo parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ObterLucratividadePeriodo object =
                    new ObterLucratividadePeriodo();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ObterLucratividadePeriodo".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ObterLucratividadePeriodo) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "ano").equals(reader.getName())) {
