...
/**
 * AtualizarComprovante bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class AtualizarComprovante
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":AtualizarComprovante",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "AtualizarComprovante",
    ...
    public static class Factory {
         ...
         */
        public static AtualizarComprovante parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            AtualizarComprovante object =
                    new AtualizarComprovante();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"AtualizarComprovante".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (AtualizarComprovante) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
