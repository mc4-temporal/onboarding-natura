/**
 * Procesar_analisis_personas.java
 * <p>
...
/**
 *  Procesar_analisis_personas bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class Procesar_analisis_personas
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":Procesar_analisis_personas",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "Procesar_analisis_personas",
    ...
    public static class Factory {
         ...
         */
        public static Procesar_analisis_personas parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            Procesar_analisis_personas object =
                    new Procesar_analisis_personas();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Procesar_analisis_personas".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (Procesar_analisis_personas) bo.com.mc4.onboarding.integrations.infocenter.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
