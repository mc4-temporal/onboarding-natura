...
/**
 * ReativarRevendedor bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class ReativarRevendedor
    ...
    /**
     * field for CodigoLiderMultinivel
     */


    protected int localCodigoLiderMultinivel;
     ...
     * @return int
     */
    public int getCodigoLiderMultinivel() {
        return localCodigoLiderMultinivel;
    }
     ...
     * Auto generated setter method
     *
     * @param param CodigoLiderMultinivel
     */
    public void setCodigoLiderMultinivel(int param) {

        this.localCodigoLiderMultinivel = param;
     ...
     * @param param Motivo
     */
    public void setMotivo(int param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":ReativarRevendedor",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "ReativarRevendedor",
        ...
        namespace = "http://www.geravd.com.br/Servicos/PessoaWebService";
        writeStartElement(null, namespace, "codigoLiderMultinivel", xmlWriter);

        if (localCodigoLiderMultinivel == java.lang.Integer.MIN_VALUE) {

            throw new org.apache.axis2.databinding.ADBException("codigoLiderMultinivel cannot be null!!");

        } else {
            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCodigoLiderMultinivel));
        }
        ...
        if (localMotivo == java.lang.Integer.MIN_VALUE) {

            throw new org.apache.axis2.databinding.ADBException("motivo cannot be null!!");

        } else {
            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localMotivo));
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        elementList.add(new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService",
                "codigoLiderMultinivel"));

        elementList.add(
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCodigoLiderMultinivel));
    ...
    public static class Factory {
         ...
         */
        public static ReativarRevendedor parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ReativarRevendedor object =
                    new ReativarRevendedor();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ReativarRevendedor".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ReativarRevendedor) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "codigoLiderMultinivel").equals(reader.getName())) {

                    java.lang.String content = reader.getElementText();

                    object.setCodigoLiderMultinivel(
                            org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(content));
