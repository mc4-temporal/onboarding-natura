/**
 * Verificaciones_consultar_estado.java
 * <p>
...
/**
 *  Verificaciones_consultar_estado bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class Verificaciones_consultar_estado
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":verificaciones_consultar_estado",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "verificaciones_consultar_estado",
    ...
    public static class Factory {
         ...
         */
        public static Verificaciones_consultar_estado parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            Verificaciones_consultar_estado object =
                    new Verificaciones_consultar_estado();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"verificaciones_consultar_estado".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (Verificaciones_consultar_estado) bo.com.mc4.onboarding.integrations.infocenter.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
