...
/**
 * ObterLiderBelcorp bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class ObterLiderBelcorp
    ...
    /**
     * field for CepIntencaoRevenda
     */


    protected java.lang.String localCepIntencaoRevenda;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localCepIntencaoRevendaTracker = false;

    public boolean isCepIntencaoRevendaSpecified() {
        return localCepIntencaoRevendaTracker;
    }
     ...
     * @return java.lang.String
     */
    public java.lang.String getCepIntencaoRevenda() {
        return localCepIntencaoRevenda;
    }
     ...
     * Auto generated setter method
     *
     * @param param CepIntencaoRevenda
     */
    public void setCepIntencaoRevenda(java.lang.String param) {
        localCepIntencaoRevendaTracker = param != null;

        this.localCepIntencaoRevenda = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":ObterLiderBelcorp",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "ObterLiderBelcorp",
        ...
        xmlWriter.writeEndElement();
        if (localCepIntencaoRevendaTracker) {
            namespace = "http://www.geravd.com.br/Servicos/PessoaWebService";
            writeStartElement(null, namespace, "cepIntencaoRevenda", xmlWriter);


            if (localCepIntencaoRevenda == null) {
                // write the nil attribute

                throw new org.apache.axis2.databinding.ADBException("cepIntencaoRevenda cannot be null!!");

            } else {


                xmlWriter.writeCharacters(localCepIntencaoRevenda);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (localCepIntencaoRevendaTracker) {
            ...
            if (localCepIntencaoRevenda != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCepIntencaoRevenda));
            } else {
                throw new org.apache.axis2.databinding.ADBException("cepIntencaoRevenda cannot be null!!");
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ObterLiderBelcorp parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ObterLiderBelcorp object =
                    new ObterLiderBelcorp();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ObterLiderBelcorp".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ObterLiderBelcorp) bo.com.mc4.onboarding.integrations.gera.wsdl.gen.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.geravd.com.br/Servicos/PessoaWebService", "cepIntencaoRevenda").equals(reader.getName())) {

                    java.lang.String content = reader.getElementText();

                    object.setCepIntencaoRevenda(
                            org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
