...
import { defaultChartOptions } from '../../../../../@mc4/shared/chart-widget/chart-widget-defaults';
import { ListColumn } from '../../../../../@mc4/shared/list/list-column.model';
import { RecentSalesWidgetOptions } from './recent-sales-widget-options.interface';

@Component({
  selector: 'mc4-recent-sales-widget',
