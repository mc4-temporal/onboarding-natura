...
import {
  buildBottomSheetConfig,
  buildBottomSheetConfigCustom,
} from "../../../commons/utils/dialog.util";
...
export class LogComponent implements OnInit {
  ...
  async ngOnInit() {
    this.resourceService
      .requestActionList(resourceCode.logResourceCod)
  ...
  applyFilter() {
    ...
    aditionalParams.from = moment(aditionalParams.from).format(
      DateUtil.buildFullDateMomentFormat("-")
    );
    aditionalParams.to = moment(aditionalParams.to).format(
      DateUtil.buildFullDateMomentFormat("-")
    );
