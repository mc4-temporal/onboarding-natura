...
import { componentDestroyed } from '../../../@mc4/shared/component-destroyed';
import { MediaObserver } from '@angular/flex-layout';
import {someMenu} from '../../commons/utils/fake-data.util';
...
export class SidenavService implements OnDestroy {
  ...
  // private successMenu = (body: ApiResponse<SidenavItem[]>) => {
  //   this.addItems(body.data);
  // }
