...
@Slf4j
@Tag(name = "municipio", description = "API para gestion de municipios")
@RestController
...
public class MunicipioController {
    ...
    public ResponseEntity<ResponseBody<List<MunicipioDto>>> getMunicipiosList(@RequestParam("id_region") long idRegion) {
        try {
            List<MunicipioDto> municipiosList = this.municipioService.municipiosListByIdRegion(idRegion);
            return ok(ApiUtil.buildResponseWithDefaults(municipiosList));
